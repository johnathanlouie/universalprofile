 ...
 *
 * Contains one abstract function: Entity union(Entity e1, Entity e2); Uses
 * HashMap to store and set field and value of the Entity This makes a Entity
 * Object's fields more generic and available for simple necessary operations
