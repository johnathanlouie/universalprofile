 ...
 *
 * Checks similarity between two Person objects using Vector Space model. Uses
 * cosine similarity between the two Person Vectors to check for similarity.
